...
exports.editApplication = void 0;
const readFileContent_1 = require("../../../helpers/readFileContent");
const editApplicationService_1 = require("../../../service/v1/applications/editApplicationService");
const editApplication = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const job = yield (0, editApplicationService_1.editApplicationService)(applicationId, {
            jobId,
            applicantName,
            applicantEmail,
            coverLetter,
